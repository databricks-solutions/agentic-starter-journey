...
```json
{
  "datasets": [
    {
      "name": "ds_kpis",
      "displayName": "Franchise performance KPIs",
      "queryLines": [
      ...
      "layout": [
        {
          "widget": {
            ...
            "multilineTextboxSpec": {
              "lines": [
                "# Bakehouse Franchise Performance"
              ]
            }
          },
          "position": {
        ...
        },
        {
          "widget": {
            ...
            "multilineTextboxSpec": {
              "lines": [
                "Daily sales, order volume, and product performance across the Bakehouse franchise network."
              ]
            }
          },
          "position": {
